...
public class Controller implements Initializable {
    ...
    @FXML private Text textObjectif;
    @FXML private Text objectif;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        demarrer.setOnAction(event -> {
            ...
            textObjectif.setOpacity(100);
            objectif.setText(Double.toString(BigDecimal.valueOf(valeurFonctionObj).setScale(1, RoundingMode.HALF_UP).doubleValue()));
